            ...
            if (user.msgids === "assistant") {
              return (
                <div className="icons">
                  ...
                  <NavLink activeClassName='activelink' exact to='/' onClick={()=>{handleLogout()}}><span> <i  className="fal fa-sign-out-alt"></i>{widemode?<p className='widemodeElement'>Logout</p>:''}</span></NavLink> 
                </div>
              )
            } else {
              return (
